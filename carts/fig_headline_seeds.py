...
OUT = "fig_headline_seeds.pdf"
DARK, LIGHT = fig_style.CARTS_BLUE, "#9DC6E0"
...
def series(data, offset, color, label):
    ...
    for dom in sorted(data):
        ...
        ax.scatter([x0 + j for j in JIT], v, s=9, color=color,
...
ax.annotate("two neutral seeds\n(naive hurts; CA recovers)",
            xy=(-0.13, 0.0), xytext=(-0.42, 7.5), fontsize=6.5,
