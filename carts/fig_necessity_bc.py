#!/usr/bin/env python3
# fig_necessity_bc.py -- APPEND-ONLY. Panels (b) and (c) of
# fig_necessity_composite_v2.py, side by side, without panel (a).
# Panel (a) now lives in fig_necessity_a_1col.py as a single-column
# figure beside Section VII-D. Same data, same anchor gates.
...
print("anchors verified -- plotting heatmaps (b) and (c)")


fig, (axb, axc) = plt.subplots(1, 2, figsize=(7.1, 2.35),
...
im = heat(axb, ca, "(a) CARTS (cost-aware)")
heat(axc, c4, "(b) Always-dedup (C4)")
