...
OUT = "fig_bandwidth_bridge_v2.pdf"
BWS  = [5, 10, 20, 50]
DPUS = [(20500, "#9DC6E0", "o", "DPU = 20.5 GB/s"),
        (50000, "#5B8FBF", "s", "DPU = 50 GB/s"),
        (83900, "#1F5C8B", "^", "DPU = 83.9 GB/s")]
...
ax.set_ylabel("mean completion-time gain vs C0 (%)")
ax.set_ylim(0, 14.5)
