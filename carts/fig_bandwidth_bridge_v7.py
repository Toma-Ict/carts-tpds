...
OUT = "fig_bandwidth_bridge_v7.pdf"
BWS  = [5, 10, 20, 50]
...
LBLOFF = {20500: (14, 16), 50000: (10, 8), 83900: (10, 8)}
...
ax.set_ylim(0, 16.5)
ax.legend(loc="upper right", title="dedup rate", title_fontsize=7,
          borderaxespad=0.2, handlelength=1.6, labelspacing=0.3)
